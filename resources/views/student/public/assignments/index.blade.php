...
@section('content')
  ...
  <div class="card" style="width: 100%">
    ...
    <table class="table table-hover table-striped" id="datatable">
      ...
      <tbody>
        @php
            // $assignments = App\Assignment::orderByDesc('deadline')->get();
            $assignments = App\Assignment::whereNotIn('id', function($q) {
        ...
        @foreach ($assignments as $assignment)
            <tr>
              ...
              <td>
                <a href="{{ route('student.public.assignment.detail', $assignment->id) }}" class="btn btn-sm btn-secondary">Lihat</a>
              </td>
            </tr>
        @endforeach
      </tbody>
